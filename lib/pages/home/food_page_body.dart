      ...
      children: [
        ...
        GetBuilder<PopularProductController>(builder: (popularProducts) {
          return DotsIndicator(
            ...
            position: _currPageValue.toInt(), // double -> int
        ...
        Container(
          margin: EdgeInsets.only(left: Dimensions.distance30),
          child: Row(
        ...
        children: [
          GestureDetector(
            ...
            child: Container(
              ...
              margin: EdgeInsets.only(
                  left: Dimensions.distance10, right: Dimensions.distance10),
              decoration: BoxDecoration(
          ...
          Align(
            ...
            child: Container(
              ...
              margin: EdgeInsets.only(
                  left: Dimensions.distance30,
                  right: Dimensions.distance30,
              ...
              child: Container(
                padding: EdgeInsets.only(
                  ...
                  left: Dimensions.distance15,
                  right: Dimensions.distance15,
                ),
                child: AppColumn(
